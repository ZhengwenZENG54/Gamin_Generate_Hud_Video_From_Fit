...
# 原模块路径
MODULE_PATH = r"E:\Desktop\Gamin_Generate_Hud_Video_From_Fit\Gamin_Generate_Hud_Video_From_Fit\generate_hud_map_elevation_video_21.py"

# 日志文件路径
LOG_FILE = "fit_video_audit_log.txt"
